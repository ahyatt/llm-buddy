...
For details on setting up providers, see [[https://github.com/ahyatt/llm][the LLM package]].  The LLM package supports most major providers, including local ones.
